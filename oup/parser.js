...
module.exports = new Parser(function analyseEC(parsedUrl) {
  ...
  if (path == '/content/current') {
  ...
  } else if (/downloaddocsetaspdf/i.test(path)) {
    ...
    // http://www.oxfordbibliographies.com:80/newsitem/176/December$00202017$002fJanuary$00202018$0020Update$0020Live;jsessionid=E159DF2929ABAF94BFCC0D07105C831C
    result.rtype    = 'REF';
    result.mime     = 'HTML';
    if (/oxfordclinicalpsych.com/i.test(hostname)) {
      result.publication_title = 'Oxford Clinical Psychology';
